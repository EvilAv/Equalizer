...
public class Equalizer {
    ...
    public void setInputSignal(short[] inputSignal) {
        ...
        this.filters[0].settings(FilterInfo.COEFS_OF_BAND_1,
                FilterInfo.COUNT_OF_COEFS, this.inputSignal);
        this.filters[1].settings(FilterInfo.COEFS_OF_BAND_2,
                FilterInfo.COUNT_OF_COEFS, this.inputSignal);
        this.filters[2].settings(FilterInfo.COEFS_OF_BAND_3,
                FilterInfo.COUNT_OF_COEFS, this.inputSignal);
        this.filters[3].settings(FilterInfo.COEFS_OF_BAND_4,
                FilterInfo.COUNT_OF_COEFS, this.inputSignal);
        this.filters[4].settings(FilterInfo.COEFS_OF_BAND_5,
                FilterInfo.COUNT_OF_COEFS, this.inputSignal);
        this.filters[5].settings(FilterInfo.COEFS_OF_BAND_6,
                FilterInfo.COUNT_OF_COEFS, this.inputSignal);
    }
